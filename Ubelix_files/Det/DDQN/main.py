...
save_folder = f'./experiments/{config["dataset"]}/{config["attack"]}/{config["heterogeneity"]}/n_{config["n"]}m{config["m"]}f{config["f"]}T{config["T"]}runs{config["nb_run"]}alpha{config["alpha"]}'
